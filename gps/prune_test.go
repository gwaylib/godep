	...
	}{
		{
			...
			co: CascadingPruneOptions{
				...
				PerProjectOptions: map[ProjectRoot]PruneOptionSet{
					ProjectRoot("github.com/gwaylib/godep"): {},
				},
			},
			results: map[ProjectRoot]PruneOptions{
				ProjectRoot("github.com/gwaylib/godep"): PruneNestedVendorDirs,
			},
		},
		{
			name: "all overridden",
			...
			results: map[ProjectRoot]PruneOptions{
				ProjectRoot("github.com/gwaylib/godep"): PruneUnusedPackages | PruneNonGoFiles | PruneGoTestFiles,
			},
		},
		{
			name: "all redundant",
